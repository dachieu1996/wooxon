                                                    ...
                                                    <article class="product type-product slick-slide" style="width: 285px; height: 348px;">
                                                        <div class="product-wrap">                                                    
                                                            <div class="product-top">                        
                                                                <figure>
                                                                    <a href="#">
                                                                    <img width="300" height="300" src="http://127.0.0.1:8888/theme4/wp-content/uploads/2018/01/mp3-1-1-300x300.jpg" class="attachment-shop_catalog size-shop_catalog"></a>
                                                                </figure>                                                                       
                                                                <!-- End .product-action -->
                                                            </div>    
                                                            <div class="product-middle">
                                                                <div class="product-brand d_flex align-items-center justify-content-between mt15">
                                                                    <div class="product_meta">Apple</div>                 
                                                                </div><!-- End .product-brand -->        
                                                                <div class="title-wrap">
                                                                    <h3 class="product-title">
                                                                        <a href="#">Mobile iPhone 7 Plus, GSM Unlocked, 32GB SmartPhone GSM Unlocked</a>
                                                                    </h3>
                                                                </div>        
                                                                <div class="d_flex align-items-center justify-content-between">
                                                                    <span class="price">355 đ</span>                                                                                                                                                                                                                                        
                                                                </div>
                                                            </div>                                                            
                                                        </div>
                                                    </article>
